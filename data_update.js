...
const datos = {
  ...
  definiciones: {
    semaforo: "Sistema tricolor con caras verticales y horizontales",
    senalesEmergencia: "Señales que se sitúan sobre la vía a 30m detrás del vehículo y serán visibles a una distancia de 150m",
    anoNatural: "En Cuba, solamente en Seguridad Vial es el período de fecha de un año a fecha igual del siguiente año",
    curvaVisibilidadReducida: "Aquella que no permite ver el ancho total de la calzada según la escala de velocidades",
    estacionamiento: "Detención por causas distintas a tomar/dejar personas o carga",
    puente: "Construcción sobre cursos de agua",
    intercambio: "Cruce de vías a diferentes niveles",
    pasoInferior: "Cruce de vía por debajo de otra o de una vía férrea",
    pasoSuperior: "Cruce de vía por encima de otra o de una vía férrea",
    recalificacion: "Entrenamiento cada 2 años para conductores. Cancelación de licencia por 6 meses si no se aprueba",
    transporteColectivo: "Ómnibus, taxi, vehículo de carga (cuando transporta personas a concentraciones, movilizaciones y otros casos autorizados)",
    cambioRasante: "Son las ondulaciones o lomas que impiden ver la continuación de la vía",
    conductorVehiculo: "Persona que guía cualquier tipo de vehículo",
    conductorNovel: "Conductor que tiene menos de 2 años de haber obtenido su licencia de conducción",
    conductorProfesional: "Persona que recibe un salario o una tarifa por conducir vehículos",
    detencionMomentanea: "Detención voluntaria de un vehículo en la vía por no más del tiempo necesario para tomar o para dejar personas o carga",
    dispositivoReflectante: "Dispositivo destinado a indicar la presencia de un vehículo o de un obstáculo por luz emanada de una fuente luminosa ajena",
    hidrante: "Conducto o toma de agua para el servicio de bomberos",
    interseccion: "Cruce de vías",
    pasoNivelConBarreras: "Equivalente a un ceda el paso (moderar la velocidad y de ser necesario parar)",
    pasoNivelSinBarreras: "Equivalente a una señal de pare (parar, mirar y seguir). Cuando carece de señal hay que parar 3 metros antes"
  },
  ...
  vehiculos: {
    ...
    omnibus: {
      nombre: "Ómnibus",
      descripcion: "Vehículo destinado al transporte de pasajeros con más de 16 asientos (sin contar el del conductor)"
    },
    microbus: {
      nombre: "Microbús",
      descripcion: "Vehículo para pasajeros con más de 8 pero no más de 16 asientos (sin contar el del conductor)"
    },
    camionRigido: {
      nombre: "Camión rígido de carga",
      descripcion: "Vehículo donde la cabina y la caja de carga están montadas sobre un mismo chasis"
    },
    camionArticulado: {
      nombre: "Camión articulado de carga",
      descripcion: "Vehículo compuesto por un tractocamión acoplado a un semirremolque"
    },
    vehiculoConRemolque: {
    ...
    vehiculosAgricolas: {
      ...
      descripcion: "Vehículos de motor utilizados para actividades agrícolas o similares"
    },
    servicioEspecial: {
      nombre: "Vehículos de servicio especial",
      descripcion: "Autorizados para servicios específicos como patrullas policiales, bomberos, ambulancias, vehículos de escolta y otros autorizados por el MININT"
    },
    combinacion: {
      nombre: "Combinación de vehículos",
      descripcion: "Conjunto de vehículos acoplados que circulan como una sola unidad"
    }
  },

  // ==================== PESO Y CAPACIDAD ====================
  pesoCapacidad: {
    capacidadNominal: "Carga útil máxima que puede transportar un vehículo",
    pesoEnCarga: "Peso total del vehículo y de su carga, incluido el personal de servicio y los pasajeros",
    tara: "Peso del vehículo sin carga, sin personal de servicio y sin pasajeros; pero con la totalidad del carburante y utensilios normales de a bordo",
    pesoPorEje: "Parte del peso total transmitido a la vía a través de cada eje"
  },
  ...
  vias: {
    ...
    unSentido: {
      ...
      caracteristica: "Tiene indicado su sentido de dirección. Generalmente con flechas en accesos transversales. Casos especiales pueden tener señales opuestas"
    },
    senalizacionUnAcceso: {
      nombre: "Señalización en un solo acceso",
      caracteristica: "La vía es de un solo sentido para el acceso señalizado y de doble sentido para el otro"
    },
    suficientementeIluminada: {
      nombre: "Vía suficientemente iluminada",
      caracteristica: "Permite distinguir un vehículo oscuro a 50 metros (visión normal)"
    }
  },
  ...
  licencias: {
    categorias: {
      a1: {
        codigo: "A-1",
        vehiculos: "Ciclomotores (hasta 50 cc o consumo eléctrico no superior a 1000 watts)",
        velocidadMaxima: "50 kph",
        edadMinima: 16
      },
      b: {
        codigo: "B",
        vehiculos: "Hasta 3500 kg y hasta 8 asientos sin contar el del conductor",
        remolque: "Puede arrastrarse un remolque ligero (hasta 750 kg)",
        edadMinima: 18
      },
      c: {
        codigo: "C",
        vehiculos: "Más de 3500 kg destinado al transporte de carga",
        remolque: "Puede arrastrarse un remolque ligero (hasta 750 kg)",
        edadMinima: 18,
        experienciaRequerida: "2 años con categoría B"
      },
      d: {
        codigo: "D",
        vehiculos: "Más de 8 asientos, sin contar el del conductor, destinado al transporte de personas",
        edadMinima: 18,
        experienciaRequerida: "2 años con categoría B"
      },
      e: {
        codigo: "E",
        vehiculos: "Conjunto de vehículos cuyo vehículo de tracción puede ser de las categorías B, C, C-1, D, D-1",
        experienciaRequerida: "2 años con categorías C y D"
      }
    },
    ...
    permisoAprendizaje: {
      ...
      sanciones: "Violaciones pueden causar cancelación del permiso con prohibición de 1 a 3 años para nuevo trámite"
    },
    ...
    extranjeros: {
      ...
      estanciaMayor: "Requieren licencia cubana (sin exámenes, solo pago de tasa)",
  ...
  senalesAgente: {
    alto: {
      ...
      circulan: "Los usuarios de la vía en el mismo sentido de los brazos del agente",
      seDetienen: "Los usuarios de la vía que se encuentran al frente y a la espalda del agente"
    },
    atencionAlto: {
    ...
    brazoAlFrente: {
      ...
      circulan: "Los vehículos que se encuentran a la izquierda del agente y cruzan los peatones a su espalda",
  ...
  banderasPolicia: {
    amarilla: {
      significado: "Se aproxima un tramo o situación peligrosa",
      accion: "Moderar la velocidad o de ser necesario parar"
    },
    roja: {
      significado: "A su paso el tránsito queda cerrado a la circulación",
      accion: "Los usuarios de la vía deben detenerse"
    },
    verde: {
      significado: "A su paso el tránsito queda abierto a la circulación",
  ...
  // ==================== SEMÁFOROS ====================
  semaforos: {
    funcion: "Regular la prioridad alternativamente en las intersecciones de gran tráfico vehicular",
    disposicion: "Sus luces se ubican de arriba abajo y de izquierda a derecha en el orden siguiente: roja, amarilla, verde",
    
    colores: {
      amarilla: "Parar vehículos y peatones hasta que cambie (los vehículos continúan cuando se encuentran tan cerca de ella que no pueden detenerse en suficientes condiciones de seguridad)",
      amarillaIntermitente: "Continuar extremando precauciones",
      roja: "Parar vehículos y peatones hasta que cambie",
      rojaIntermitenteInterseccion: "Parar, mirar y seguir",
      rojaIntermitenteEspecial: "Parar vehículos y peatones y no continuar mientras estén encendidas (ante vuelo rasante de aeronaves, puentes móviles, pasos a nivel, salidas de automóviles de bomberos, de patrullas y de ambulancias)",
      verde: "Recto, girar derecha, y con precaución sin obstruir la vía girar izquierda",
      verdeFlechas: "Autoriza las maniobras que dichas flechas indican",
      verdeFlechaIzquierda: "Autoriza girar hacia la izquierda, y circulando por una vía de doble sentido de circulación autoriza el giro en 'U' o media vuelta",
      verdeIntermitente: "Indica que su tiempo está por concluir"
    }
  },

  // ==================== SEÑALES HORIZONTALES ====================
  senalesHorizontales: {
    pasoPeatonalCebra: "Concede prioridad a los peatones",
    pasoPeatonalFranja: "Concede prioridad a los vehículos",
    lineaCedaPaso: "Moderar la velocidad y de ser necesario parar",
    lineaPare: "Parar ante ella, mirar y seguir",
    lineaDiscontinuaParalela: "Los vehículos podrán cruzarla según lo requieran",
    lineaContinuaParalela: "Ningún vehículo podrá cruzarla ni circular sobre ella",
    dobleLineaContinua: "Ningún vehículo podrá cruzarla ni circular sobre ella. Indica una peligrosidad mayor",
    lineaContinuaIzquierda: "Cuando esté cerca del lado izquierdo del conductor no la podrá cruzar",
    lineaDiscontinuaIzquierda: "Cuando esté más cerca del lado izquierdo del conductor la podrá cruzar",
    lineaContinuaRegreso: "Para regresar a la senda o carril por el que se transitaba se podrá cruzar",
    lineaContinuaDerecha: "Si está en el borde extremo derecho de la vía se podrá cruzar"
  },

  // ==================== OTRAS SEÑALES ====================
  otrasSeñales: {
    brazoHorizontal: "Para girar a la izquierda o para cambiar de senda o carril a la izquierda",
    brazoVertical: "Para girar a la derecha o para cambiar de senda o carril a la derecha",
    brazoInclinado: "Para detenerse o disminuir la velocidad",
    brazoMovimiento: "Para realizar el retroceso o marcha atrás",
    triangularReflectante: "Para señalar rotura, desperfecto o accidente",
    banderasRojasCarga: "Para cargas que sobresalen más de un metro por delante o por detrás del vehículo del amanecer al anochecer, debe ser visible a 100m",
    luzRojaCarga: "Para cargas que sobresalen más de un metro por detrás del vehículo del anochecer al amanecer, debe ser visible a 100m",
    luzBlancaCarga: "Para cargas que sobresalen más de un metro por delante del vehículo del anochecer al amanecer, debe ser visible a 100m",
    ganaderoCruce: "A 100 m con bandera roja un ganadero a cada lado del rebaño para el cruce de ganado por una vía rural pavimentada del amanecer al anochecer",
    ganaderoTraslado: "A 100 m con bandera roja un ganadero delante y otro detrás del rebaño para el traslado de ganado por una vía rural pavimentada del amanecer al anochecer"
  },
  ...
  usoViasCarriles: {
    dosOMasCarrilesMismoSentido: {
      carrilExtremaIzquierda: "Obligación de mantener el límite máximo de velocidad que se establece",
      carrilExtremaDerecha: "Marcha lenta. En zona rural se considera marcha lenta cuando se circula a velocidad inferior a 60 kph"
    },

    dobleSentidoTresCarriles: {
  ...
  maniobras: {
    giros: {
      derecha: "Desde la senda o carril de la extrema derecha de la vía por donde se circula hacia cualquier senda o carril de la vía donde se efectuará la incorporación",
      izquierda: "Desde la senda o carril de la extrema izquierda de la vía por donde se circula hacia cualquier senda o carril de la vía donde se efectuará la incorporación",
      autorizadosPorFlechas: "Obligación de realizarlos como lo indican las flechas y mantener la misma posición de senda o carril",
      ciclocarriles: "La prioridad corresponde a los ciclos, a no ser que mediante señales se le conceda la prioridad a los demás vehículos"
    },
    ...
    adelantamiento: {
      ...
      excepcion: "Se permite adelantar en los cambios de rasante y en las curvas de visibilidad reducida si hay más de una senda o carril en el mismo sentido"
    },
  ...
  transportePersonas: {
    prohibicionGeneral: "Se prohíbe transportar pasajeros en vehículos destinados al transporte de carga, excepto en los casos autorizados",
  ...
  transporteCargas: {
    prohibicionGeneral: "Se prohíbe el trasbordo de carga o de otros objetos de un vehículo a otro encima de la calzada",
    ...
    prohibicionTuneles: "Se prohíbe circular por túneles transportando materiales inflamables, explosivos o tóxicos",

    prohibicionFumar: "Se prohíbe fumar al conductor, ayudantes o pasajeros transportando materiales inflamables o explosivos"
  },
  ...
  dispositivosVehiculo: {
    ...
    ruido: "Se prohíbe utilizar en el vehículo dispositivos que puedan provocar ruidos intensos o estridentes",

    espejos: {
      visibilidadMinima: "A 50 m como mínimo deben permitir ver hacia atrás, sin que se distorsione la imagen",
      obligacion: "Obligación de portar uno o varios, según las características del vehículo",
      puntoCiego: "Se denomina punto ciego al ángulo en el cual el espejo o espejos retrovisores no captan imagen"
    },

    matriculas: {
      obligacion: "Obligación de portar en el vehículo una trasera y otra delantera",
      visibilidad: "Deben ser legibles a 40 m",
      iluminacionNocturna: "Del anochecer al amanecer la luz blanca que ilumina la matrícula trasera, deberá permitir que con el vehículo detenido y en condiciones normales de visibilidad dicha matrícula sea visible a 20 m"
    },
  ...
  lucesDispositivos: {
    ...
    lucesDelanteras: {
      ...
      motocicletas: {
        mas40kph: "Una luz de carretera o larga y una luz de cruce o corta, integradas en una sola unidad",
        menos40kph: "Una luz de cruce o corta"
      },
      color: "Las luces de carretera o largas y las de cruce o cortas serán blancas o de color amarillo selectivo"
    },

    lucesPosicion: {
      visibilidad: "300 m",
      proposito: "Indican la presencia y ancho del vehículo en marcha o estacionado",
      configuraciones: {
        estandar: "Dos rojas traseras y 2 blancas o de color amarillo selectivo delanteras",
        vehiculosAltos: "El vehículo que sobrepase de 2 m de altura portará estas luces en las partes superiores delantera y trasera",
        tractores: "Dos rojas traseras",
        motocicletas: "Una roja trasera",
        sidecar: "Una roja trasera y una blanca o de color amarillo selectivo delantera",
        remolques: "Dos rojas traseras y a no más de 15 cm de sus exteriores en cada extremo lateral delantero una blanca o de color amarillo selectivo. También tendrán luces laterales a no más de 1.5 m una de otra",
        remolquesEstrecho: "Remolque que no sobrepase de 80 cm de ancho: podrá circular con una luz roja trasera"
      }
    },
    ...
    dispositivosReflectantes: {
      ...
      formas: {
        remolques: "En forma de triángulo equilátero, sus lados no mayores de 20 cm ni menores de 15 cm",
    ...
    lucesFrenado: {
      color: "rojo intenso",
      requisito: "La portará en su parte trasera todo vehículo de motor capaz de alcanzar 25 kph"
    },

    lucesIntermitentes: {
      uso: "Se utilizan tanto de día como de noche",
      color: "amarillo (En la parte trasera se admite el color rojo cuando así se diseñó por el fabricante)"
    },

    luzMatricula: {
      color: "blanca",
      proposito: "Permitirá que la matrícula trasera sea visible de noche, en condiciones normales y con el vehículo detenido",
      visibilidad: "20 m"
    },

    reglasEspeciales: {
      condicionesAdversas: "Luces de cruce o cortas o luces de niebla en caso de niebla densa, lluvia intensa o copiosa, nubes de humo o de polvo",
      
      zonaUrbanaYTuneles: {
        iluminacionSuficiente: "Luces de cruce o cortas o luces de posición",
        iluminacionInsuficiente: "Luces de carretera o largas, altas o directas"
      },

      senalizacionLuces: {
        adelantar: "Cambios rápidos alternos de luces de carretera por luces de cruce",
        curvas: "Cambios espaciados a intervalos regulares para entrar a un cambio de rasante o a una curva de visibilidad reducida"
      },
    ...
    ciclosTraccionAnimal: {
      ...
      ciclosVariasRuedas: {
        delantero: "Una luz blanca o amarilla",
        trasero: "Dos luces rojas o dos dispositivos reflectantes rojos, uno a cada lado"
      },
      traccionAnimal: {
        delantero: "Una luz blanca en la parte superior delantera izquierda",
        trasero: "Una luz roja en la parte inferior trasera izquierda y un dispositivo reflectante a cada lado"
      }
    }
  },
  ...
  regulacionesCiclos: {
    ...
    sanciones: "Por reiteración de las prohibiciones establecidas puede retenerse el ciclo de uno a seis meses y de infringirse nuevamente dentro de dos años siguientes de cumplirse esta medida podrá disponerse el decomiso"
  },
  ...
  regulacionesPeatones: {
    ...
    metodoCruce: "Cruzar la vía de forma rápida. Cuando existan pasos peatonales cruzar por estos",
    prioridad: "El paso peatonal tipo cebra concede prioridad con respecto a los vehículos, el de tipo franja establece la prioridad para los vehículos",
    zonaUrbana: "Por zona urbana circular por la parte derecha de la acera",
    zonaRural: "Por zona rural circular por la izquierda de la vía de frente al tránsito",
  ...
  obligacionesAccidentes: {
    notificacionInmediata: "El conductor de un vehículo implicado en un accidente de tránsito debe dar cuenta de inmediato a la PNR cuando:",
    ...
    posicionVehiculo: "Se mantendrá el vehículo en la misma posición que resulte del accidente cuando haya personas muertas o lesionadas. Se situarán las señales establecidas y se tratará de restablecer la circulación",

    excepciones: "Por excepción se podrá mover el vehículo cuando sea necesario brindar auxilio a víctimas, incluido el propio conductor, el cual deberá retornar al lugar de accidente, excepto que quede hospitalizado o su estado de salud se lo impida"
  },
